...
//        setDrawSliceText(false);
     ...
     */
    public ZPieChart setPieDataSetDrawValues(boolean enabled) {
        if (pieDataSet != null)
     ...
     * @param f 格式化
     */
    public ZPieChart setPieDataValueFormatter(IValueFormatter f) {
        if (pieData != null)
     ...
     * @param shift 距离
     */
    public ZPieChart setPieDataSetSelectionShift(float shift) {
        if (pieDataSet != null)
     ...
     * @param spaceDp 间隙
     */
    public ZPieChart setPieDataSetSliceSpace(float spaceDp) {
        if (pieDataSet != null)
     ...
     */
    public ZPieChart setPieDataSetYValuePosition(PieDataSet.ValuePosition yValuePosition) {
        if (pieDataSet != null)
     ...
     */
    public ZPieChart setPieDataSetValueLineColor(int valueLineColor) {
        if (pieDataSet != null)
     ...
     */
    public ZPieChart setPieDataSetValueLinePart1OffsetPercentage(float valueLinePart1OffsetPercentage) {
        if (pieDataSet != null)
     ...
     */
    public ZPieChart setPieDataSetValueLinePart2Length(float valueLinePart2Length) {
        if (pieDataSet != null)
     ...
     */
    public ZPieChart setPieDataSetValueLinePart1Length(float valueLinePart1Length) {
        if (pieDataSet != null)
     ...
     * @param tf 文字的样式
     */
    public ZPieChart setPieDataSetValueTypeface(Typeface tf) {
        if (pieDataSet != null)
     ...
     */
    public ZPieChart setPieDataSetValueTextColor(int color) {
        if (pieDataSet != null)
     ...
     * @param size 文字大小
     */
    public ZPieChart setPieDataSetValueTextSize(float size) {
        if (pieDataSet != null)
     ...
     */
    public ZPieChart setLegendOrientation(Legend.LegendOrientation value) {
        if (mLegend != null)
     ...
     * @param value 上中下
     */
    public ZPieChart setLegendVerticalAlignment(Legend.LegendVerticalAlignment value) {
        if (mLegend != null)
     ...
     * @param value 左中右
     */
    public ZPieChart setLegendHorizontalAlignment(Legend.LegendHorizontalAlignment value) {
        if (mLegend != null)
     ...
     * @param space 待显示间距
     */
    public ZPieChart setLegendXEntrySpace(float space) {
        if (mLegend != null)
     ...
     * @param space 待显示间距
     */
    public ZPieChart setLegendYEntrySpace(float space) {
        if (mLegend != null)
     ...
     * @param yOffset 偏移值
     */
    public ZPieChart setLegendYOffset(float yOffset) {
        if (mLegend != null)
     ...
     * @param xOffset 偏移值
     */
    public ZPieChart setLegendXOffset(float xOffset) {
        if (mLegend != null)
     ...
     */
    public ZPieChart setLegendTextColor(int color) {
        if (mLegend != null)
     ...
     * @param size 文字的大小 dp
     */
    public ZPieChart setLegendTextSize(float size) {
        if (mLegend != null)
     ...
     */
    public ZPieChart setLegendForm(Legend.LegendForm shape) {
        if (mLegend != null)
     ...
     * @param enabled 是否显示
     */
    public ZPieChart setDescriptionEnabled(boolean enabled) {
        if (mDescription != null)
